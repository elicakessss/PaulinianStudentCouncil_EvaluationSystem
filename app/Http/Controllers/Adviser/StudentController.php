...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('adviser.students.index', compact('students', 'department'));
    }
    ...
    public function create()
    {
        ...
        return view('adviser.students.create', compact('department'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('adviser.students.edit', compact('student', 'department'));
    }
