                ...
                <div class="card-body">
                    <form action="{{ route('student.account.update') }}" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('student.account') }}" class="btn btn-secondary me-2">Cancel</a>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <form action="{{ route('student.account.update-profile-picture') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
