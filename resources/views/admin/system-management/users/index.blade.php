...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.users.create', ['role' => $role]) }}" class="btn btn-success">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs mb-3">
                <li class="nav-item">
                    <a class="nav-link {{ $role === 'student' ? 'active' : '' }}" href="{{ route('admin.users.index', ['role' => 'student']) }}">Students</a>
                </li>
                <li class="nav-item">
                    ...
                    <tbody>
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('admin.users.edit', ['id' => $user->id, 'role' => $role]) }}" class="btn btn-sm btn-primary me-2">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('admin.users.destroy', ['id' => $user->id, 'role' => $role]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this {{ $role }}?')">
                                            @csrf
                                            @method('DELETE')
