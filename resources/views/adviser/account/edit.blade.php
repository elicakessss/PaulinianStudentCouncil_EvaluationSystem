    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('adviser.account.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('adviser.account') }}" class="btn btn-secondary me-2">Cancel</a>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <form action="{{ route('adviser.account.update-profile-picture') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('adviser.account.update-password') }}" method="POST">
                        @csrf
                        @method('PUT')
