        ...
        <div class="user-info">
            ...
            <div class="dropdown">
                <a href="#" class="dropdown-toggle d-flex align-items-center" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none; color: white;">
                    @if(Auth::guard('adviser')->user()->profile_picture)
                        <div class="navbar-avatar">
                            <img src="{{ asset('storage/' . Auth::guard('adviser')->user()->profile_picture) }}" alt="Profile Picture" style="width: 32px; height: 32px; object-fit: cover;">
                        </div>
                    @else
                        <div class="navbar-avatar">
